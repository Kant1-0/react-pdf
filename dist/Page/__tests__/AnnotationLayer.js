...
describe('AnnotationLayer', function () {
  ...
  describe('rendering', function () {
    ...
    _regenerator.default.mark(function _callee6() {
      var _makeAsyncCallback6, onRenderAnnotationLayerSuccess, onRenderAnnotationLayerSuccessPromise, rotate, component;

      return _regenerator.default.wrap(function _callee6$(_context6) {
        while (1) {
          switch (_context6.prev = _context6.next) {
            case 0:
              _makeAsyncCallback6 = (0, _utils.makeAsyncCallback)(), onRenderAnnotationLayerSuccess = _makeAsyncCallback6.func, onRenderAnnotationLayerSuccessPromise = _makeAsyncCallback6.promise;
              rotate = 90;
              component = (0, _enzyme.mount)(_react.default.createElement(_AnnotationLayer.AnnotationLayerInternal, {
                linkService: linkService,
                onRenderAnnotationLayerSuccess: onRenderAnnotationLayerSuccess,
    ...
    _regenerator.default.mark(function _callee7() {
      var _makeAsyncCallback7, onRenderAnnotationLayerSuccess, onRenderAnnotationLayerSuccessPromise, scale, component;
