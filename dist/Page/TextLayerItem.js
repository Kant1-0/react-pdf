...
function (_PureComponent) {
  ...
  (0, _createClass2.default)(TextLayerItemInternal, [{
    ...
    value: function () {
      ...
      /*#__PURE__*/
      _regenerator.default.mark(function _callee(fontFamily) {
        var page, font;
    ...
    value: function () {
      ...
      _regenerator.default.mark(function _callee2() {
        var element, _this$props, fontName, scale, width, targetWidth, fontData, actualWidth, widthDisproportion, repairsNeeded, fallbackFontName, ascent;
